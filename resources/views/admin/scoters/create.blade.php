...
<!-- Content Row -->
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('admin.scoters.store') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="scoter_number">{{ __('Scoter Number') }}</label>
                        <input type="text" class="form-control" id="scoter_number" placeholder="{{ __('scoter number') }}" name="scoter_number" value="{{ old('scoter_number') }}" />
                    </div>
                    <div class="form-group">
