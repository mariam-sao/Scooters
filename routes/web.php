...
Route::group(['middleware' => ['isAdmin','auth'],'prefix' => 'admin', 'as' => 'admin.'], function() {
    ...
    Route::resource('scoters', \App\Http\Controllers\Admin\ScoterController::class);
    Route::delete('scoters_mass_destroy', [\App\Http\Controllers\Admin\ScoterController::class, 'massDestroy'])->name('scoters.mass_destroy');
    ...
    Route::get('find_scoters', [\App\Http\Controllers\Admin\FindScoterController::class, 'index'])->name('find_scoters.index');
    Route::post('find_scoters', [\App\Http\Controllers\Admin\FindScoterController::class, 'index']);
