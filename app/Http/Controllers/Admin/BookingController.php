...
class BookingController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $scoters = Scoter::get()->pluck('scoter_number', 'id');
        $scoterId = $request->get('scoter_id');
        $timeFrom = $request->get('time_from');
        $timeTo = $request->get('time_to');

    return view('admin.bookings.create', compact('customers', 'scoters', 'scoterId', 'timeFrom', 'timeTo'));
    }
    ...
    public function edit(Booking $booking)
    {
        ...
        return view('admin.bookings.edit', compact('booking', 'customers', 'scoters'));
    }
